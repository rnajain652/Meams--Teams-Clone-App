...
// const socket = io("http://localhost:8080");     //local server
const socket = io("https://meams.herokuapp.com/");           //hosted server
...
const ContextProvider = ({ children }) => {
    ...
    return (
        <SocketContext.Provider value={{ call, callAccepted, myVideo, userVideo, stream, name, callEnded, me, userID, muteaudio, mutevideo, screen, callUser, setName, answerCall, leaveCall, toggleaudio, togglevideo, screenshare, stopscreenshare }}>
            {children}
