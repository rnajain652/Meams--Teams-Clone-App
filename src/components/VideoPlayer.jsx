...
const useStyles = callAccepted =>
    makeStyles((theme) => ({
        video: {
            width: callAccepted ? '550px' : '640px',
...
const VideoPlayer = () => {
    ...
    const classes = useStyles(callAccepted)();
    return (
                ...
                stream && (
                    <Paper className={classes.paper}>
                        <Grid item xs={12} md={12}>
                            ...
                            <video playsInline muted ref={myVideo} autoPlay className={classes.video} className={classes.myvideo} />
